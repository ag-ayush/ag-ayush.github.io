...
## The Story
I picked up this IOT project from R&D at the Computer Science House.
Spencer, the current R&D director of CSH, had the hardware (stepper motor, housing for stepper motor, and the stepper motor driver) and asked if someone could do the software by [ImagineRIT](https://www.rit.edu/imagine/).
...
I started the project by figuring out how to use the RPi.GPIO library by making a simple program with LEDs.
...
Thankfully, the current OpComm director of CSH, Steven, helped me out during the OpCommathon by showing me OpenShift.
...
I asked around, and upon the suggestion of the current financial director of CSH, Devin, I decided to implement **Ajax**.
...
With the help of the current chairman of CSH, Jordan, I was able to get the Flask application on the Pi running on HTTPS, thereby allowing communication between the CSH domain and the Pi.
